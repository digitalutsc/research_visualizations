...
_d2.default.json('./example_json_files/example_cal.json', function (err, data) {
  if (err) return console.warn(err);
  _d2.default.jsonldVis(data, '#graph-cal', { w: 1000, h: 600, maxLabelWidth: 300, minRadius: 25,
											transitionDuration: 750, transitionEase: 'cubic-in-out',
											scalingFactor: 2});
});
	
_d2.default.json('./example_json_files/example_van.json', function (err, data) {
  if (err) return console.warn(err);
  _d2.default.jsonldVis(data, '#graph-van', { w: 1000, h: 600 , maxLabelWidth: 350, minRadius: 10,
											transitionDuration: 120, transitionEase: 'cubic-in-out',
											scalingFactor: 5});
});
